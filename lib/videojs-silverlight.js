...
videojs.Silverlight.prototype.setSrc = function(src){
    // TODO: Need absolute url here?
...
videojs.Silverlight.prototype.setCurrentTime = function(seconds) {
	...
	videojs.MediaTechController.prototype.setCurrentTime.call(this);
...
videojs.Silverlight.prototype.setLastStatus = function (status) {
...
videojs.Silverlight.onEvent = function(xapId, status) {
    var el = document.getElementById(xapId);
    if (el.tech) {
        el.tech.lastState = status;
    }
};
